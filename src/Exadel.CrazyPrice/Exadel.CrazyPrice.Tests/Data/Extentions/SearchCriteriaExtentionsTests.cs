...
namespace Exadel.CrazyPrice.Tests.Data.Extentions
{
    public class SearchCriteriaExtentionsTests
    {
        ...
        public void GetQueryFreeTest()
        {
            ...
            sort.GetQuery().Should().BeEquivalentTo("{$and : [{\"address.country\" : \"\"}, {\"address.city\" : \"\"}, {\"language\" : \"russian\"}, {\"deleted\" : false}, {\"startDate\" : {$lte : ISODate(\"2021-01-01T07:10:10Z\")} }, {\"endDate\" : {$gte : ISODate(\"2021-01-01T07:10:10Z\")} }, {\"amountOfDiscount\" : {$lte : 10} }, {\"amountOfDiscount\" : {$gte : 100} }, {\"ratingTotal\" : {$lte : 1} }, {\"ratingTotal\" : {$gte : 5} }, {\"company.name\" : \"AdvancedName\"}]}");
        }
