    ...
    public static class CustomTestUsers
    {
        public static IEnumerable<CustomUser> Users =>
            new CustomUser[]
            {
                new CustomUser
                {
                    UserUid = new Guid("97b248a1-c706-4987-9b31-101429ec2aff"),
                    Username = "Frank",
                ...
                new CustomUser
                {
                    UserUid = new Guid("13b4e6a3-42f2-4a43-be4e-7fc15454a7ab"),
                    Username = "Claire",
                ...
                new CustomUser
                {
                    UserUid = new Guid("10c1a0a1-556a-475f-9597-c705dc1cc48b"),
                    Username = "Bob",
                    Email = "Bob@gmail.com",
